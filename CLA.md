...
submitted to the Radix_Plus project.

Radix_Plus is an open-source project intended to remain free, public, and
...
- Radix_Plus will remain an **open-source project**
...
- include them as part of Radix_Plus
...
- All Contributions will be made publicly available under the
  **GNU General Public License (GPL)** as part of Radix_Plus.
...
Submitting a Contribution to Radix_Plus means you accept this Agreement.
